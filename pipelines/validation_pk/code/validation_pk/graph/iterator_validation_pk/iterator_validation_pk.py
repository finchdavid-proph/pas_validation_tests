...
class iterator_validation_pk(MetaGemExec):
    ...
    def execute(self, spark: SparkSession, subgraph_config: SubgraphConfig) -> List[DataFrame]:
        ...
        df_source_bronze_pk_1 = source_bronze_pk_1(spark)
        df_count_records = count_records(spark, df_source_bronze_pk_1)
        df_evaluate_keep_logic = evaluate_keep_logic(spark, df_count_records)
